# 2016 dc registry settings

class base_cis::base_windows::twentysixteen_dc_registry {
...
# rule_2.2.2_L1_Ensure_Access_this_computer_from_the_network_is_set_to_Administrators_Authenticated_Users_ENTERPRISE_DOMAIN_CONTROLLERS_DC_only
# rule_2.2.4_L1_Ensure_Act_as_part_of_the_operating_system_is_set_to_No_One
# rule_2.2.5_L1_Ensure_Add_workstations_to_domain_is_set_to_Administrators_DC_only
# rule_2.2.6_L1_Ensure_Adjust_memory_quotas_for_a_process_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE
# rule_2.2.7_L1_Ensure_Allow_log_on_locally_is_set_to_Administrators
# rule_2.2.8_L1_Ensure_Allow_log_on_through_Remote_Desktop_Services_is_set_to_Administrators_DC_only
# rule_2.2.10_L1_Ensure_Back_up_files_and_directories_is_set_to_Administrators
# rule_2.2.11_L1_Ensure_Change_the_system_time_is_set_to_Administrators_LOCAL_SERVICE
# rule_2.2.12_L1_Ensure_Change_the_time_zone_is_set_to_Administrators_LOCAL_SERVICE
# rule_2.2.13_L1_Ensure_Create_a_pagefile_is_set_to_Administrators
# rule_2.2.14_L1_Ensure_Create_a_token_object_is_set_to_No_One
# rule_2.2.15_L1_Ensure_Create_global_objects_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE
# rule_2.2.16_L1_Ensure_Create_permanent_shared_objects_is_set_to_No_One
# rule_2.2.17_L1_Ensure_Create_symbolic_links_is_set_to_Administrators_DC_only
# rule_2.2.19_L1_Ensure_Debug_programs_is_set_to_Administrators
# rule_2.2.20_L1_Ensure_Deny_access_to_this_computer_from_the_network_is_set_to_Guests_DC_only
# rule_2.2.22_L1_Ensure_Deny_log_on_as_a_batch_job_to_include_Guests
# rule_2.2.23_L1_Ensure_Deny_log_on_as_a_service_to_include_Guests
# rule_2.2.24_L1_Ensure_Deny_log_on_locally_to_include_Guests
# rule_2.2.25_L1_Ensure_Deny_log_on_through_Remote_Desktop_Services_is_set_to_Guests_DC_only
# rule_2.2.27_L1_Ensure_Enable_computer_and_user_accounts_to_be_trusted_for_delegation_is_set_to_Administrators_DC_only
# rule_2.2.29_L1_Ensure_Force_shutdown_from_a_remote_system_is_set_to_Administrators
# rule_2.2.30_L1_Ensure_Generate_security_audits_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE
# rule_2.2.31_L1_Ensure_Impersonate_a_client_after_authentication_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE_DC_only
# rule_2.2.33_L1_Ensure_Increase_scheduling_priority_is_set_to_Administrators
# rule_2.2.34_L1_Ensure_Load_and_unload_device_drivers_is_set_to_Administrators
# rule_2.2.35_L1_Ensure_Lock_pages_in_memory_is_set_to_No_One
# rule_2.2.37_L1_Ensure_Manage_auditing_and_security_log_is_set_to_Administrators_and_when_Exchange_is_running_in_the_environment_Exchange_Servers_DC_only
# rule_2.2.39_L1_Ensure_Modify_an_object_label_is_set_to_No_One
# rule_2.2.40_L1_Ensure_Modify_firmware_environment_values_is_set_to_Administrators
# rule_2.2.41_L1_Ensure_Perform_volume_maintenance_tasks_is_set_to_Administrators
# rule_2.2.42_L1_Ensure_Profile_single_process_is_set_to_Administrators
# rule_2.2.43_L1_Ensure_Profile_system_performance_is_set_to_Administrators_NT_SERVICEWdiServiceHost
# rule_2.2.44_L1_Ensure_Replace_a_process_level_token_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE
# rule_2.2.45_L1_Ensure_Restore_files_and_directories_is_set_to_Administrators
# rule_2.2.46_L1_Ensure_Shut_down_the_system_is_set_to_Administrators
# rule_2.2.47_L1_Ensure_Synchronize_directory_service_data_is_set_to_No_One_DC_only
# rule_2.2.48_L1_Ensure_Take_ownership_of_files_or_other_objects_is_set_to_Administrators
######################################
...
# rule_2.3.5.1_L1_Ensure_Domain_controller_Allow_server_operators_to_schedule_tasks_is_set_to_Disabled_DC_only
registry_value { 'HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Lsa\SubmitControl':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule_2.3.5.2_L1_Ensure_Domain_controller_LDAP_server_signing_requirements_is_set_to_Require_signing_DC_only
registry_value { 'HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NTDS\Parameters\LDAPServerIntegrity':
  ensure => present,
  type   => dword,
  data   => 2,
}

# rule_2.3.5.3_L1_Ensure_Domain_controller_Refuse_machine_account_password_changes_is_set_to_Disabled_DC_only
registry_value { 'HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Netlogon\Parameters\RefusePasswordChange':
  ensure => present,
  type   => dword,
  data   => 0,
}
...
# rule_2.3.10.1_L1_Ensure_Network_access_Allow_anonymous_SIDName_translation_is_set_to_Disabled
...
# rule_2.3.10.6_L1_Configure_Network_access_Named_Pipes_that_can_be_accessed_anonymously_DC_only
$nullsessionpipes_array = ['LSARPC',
'NETLOGON',
'SAMR',
]
...
# rule_2.3.10.9_L1_Configure_Network_access_Remotely_accessible_registry_paths_and_sub-paths
...
# rule_2.3.10.10_L1_Ensure_Network_access_Restrict_anonymous_access_to_Named_Pipes_and_Shares_is_set_to_Enabled
...
# rule_2.3.10.12_L1_Ensure_Network_access_Shares_that_can_be_accessed_anonymously_is_set_to_None
...
# rule_2.3.10.13_L1_Ensure_Network_access_Sharing_and_security_model_for_local_accounts_is_set_to_Classic_-_local_users_authenticate_as_themselves
...
# rule_18.1.2.2_L1_Ensure_Allow_input_personalization_is_set_to_Disabled
registry_value { 'HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\InputPersonalization\AllowInputPersonalization':
  ensure => present,
  type   => dword,
  data   => 0,
}
...
# rule_18.3.5_L1_Ensure_Turn_on_Windows_Defender_protection_against_Potentially_Unwanted_Applications_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine\MpEnablePus':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.3.6_L1_Ensure_WDigest_Authentication_is_set_to_Disabled
...
# rule_18.5.8.1_L1_Ensure_Enable_insecure_guest_logons_is_set_to_Disabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanWorkstation\AllowInsecureGuestAuth':
  ensure => present,
  type   => dword,
  data   => 0,
}
...
# rule_18.5.11.3_L1_Ensure_Prohibit_use_of_Internet_Connection_Sharing_on_your_DNS_domain_network_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Network Connections\NC_ShowSharedAccessUI':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule_18.5.11.4_L1_Ensure_Require_domain_users_to_elevate_when_setting_a_networks_location_is_set_to_Enabled
...
# rule_18.8.21.4_L1_Ensure_Continue_experiences_on_this_device_is_set_to_Disabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System\EnableCdp':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule_18.8.21.5_L1_Ensure_Turn_off_background_refresh_of_Group_Policy_is_set_to_Disabled
...
# rule_18.8.27.1_L1_Ensure_Block_user_from_showing_account_details_on_sign-in_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System\BlockUserFromShowingAccountDetailsOnSignin':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.8.27.2_L1_Ensure_Do_not_display_network_selection_UI_is_set_to_Enabled
...
# rule_18.8.27.3_L1_Ensure_Do_not_enumerate_connected_users_on_domain-joined_computers_is_set_to_Enabled
...
# rule_18.8.27.5_L1_Ensure_Turn_off_app_notifications_on_the_lock_screen_is_set_to_Enabled
...
# rule_18.8.27.6_L1_Ensure_Turn_off_picture_password_sign-in_is_set_to_Enabled
...
# rule_18.8.27.7_L1_Ensure_Turn_on_convenience_PIN_sign-in_is_set_to_Disabled
...
# rule_18.8.28.1_L1_Ensure_Untrusted_Font_Blocking_is_set_to_Enabled_Block_untrusted_fonts_and_log_events
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\MitigationOptions\MitigationOptions_FontBocking':
  ensure => present,
  type   => string,
  data   => '1000000000000',
}

# rule_18.8.33.6.3_L1_Ensure_Require_a_password_when_a_computer_wakes_on_battery_is_set_to_Enabled
...
# rule_18.8.33.6.4_L1_Ensure_Require_a_password_when_a_computer_wakes_plugged_in_is_set_to_Enabled
...
# rule_18.9.10.1.1_L1_Ensure_Configure_enhanced_anti-spoofing_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Biometrics\FacialFeatures\EnhancedAntiSpoofing':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.9.13.1_L1_Ensure_Turn_off_Microsoft_consumer_experiences_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\CloudContent\DisableWindowsConsumerFeatures':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.9.14.1_L1_Ensure_Require_pin_for_pairing_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Connect\RequirePinForPairing':
  ensure => present,
  type   => dword,
  data   => 1,
}
...
# rule_18.9.16.1_L1_Ensure_Allow_Telemetry_is_set_to_Enabled_0_-_Security_Enterprise_Only_or_Enabled_1_-_Basic
...
# rule_18.9.16.3_L1_Ensure_Disable_pre-release_features_or_settings_is_set_to_Disabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\PreviewBuilds\EnableConfigFlighting':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule_18.9.16.4_L1_Ensure_Do_not_show_feedback_notifications_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection\DoNotShowFeedbackNotifications':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.9.16.5_L1_Ensure_Toggle_user_control_over_Insider_builds_is_set_to_Disabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\PreviewBuilds\AllowBuildPreview':
  ensure => present,
  type   => dword,
  data   => 0,
}
...
# rule_18.9.44.1_L1_Ensure_Block_all_consumer_Microsoft_account_user_authentication_is_set_to_Enabled
...
# rule_18.9.60.3_L1_Ensure_Allow_indexing_of_encrypted_files_is_set_to_Disabled
...
# rule_18.9.76.13.1.1_L1_Ensure_Configure_Attack_Surface_Reduction_rules_is_set_to_Enabled
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\ExploitGuard_ASR_Rules':
  ensure => present,
  type   => dword,
  data   => 1,
}

# rule_18.9.76.13.1.2_L1_Ensure_Configure_Attack_Surface_Reduction_rules_Set_the_state_for_each_ASR_rule_is_configured
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\75668c1f-73b5-4cf0-bb93-3ecf5cb7cc84':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\3b576869-a4ec-4529-8536-b80a7769e899':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\d4f940ab-401b-4efc-aadc-ad5f3c50688a':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\92e97fa1-2edf-4476-bdd6-9dd0b4dddc7b':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\5beb7efe-fd9a-4556-801d-275e5ffc04cc':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\d3e037e1-3eb8-44c8-a917-57927947596d':
  ensure => present,
  type   => string,
  data   => '1',
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\be9ba2d9-53ea-4cdc-84e5-9b1eeee46550':
  ensure => present,
  type   => string,
  data   => '1',
}

# rule 18.9.76.13.3.1 L1 Ensure Prevent users and apps from accessing dangerous websites is set to Enabled Block
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\Network Protection\EnableNetworkProtection':
  ensure => present,
  type   => dword,
  data   => 1,
}
...
# rule_18.9.79.1.1_L1_Ensure_Prevent_users_from_modifying_settings_is_set_to_Enabled
...
# For version 1709 or later
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System\ShellSmartScreenLevel':
  ensure => present,
  type   => string,
  data   => 'block',
}
...
# rule_18.9.84.2_L1_Ensure_Allow_Windows_Ink_Workspace_is_set_to_Enabled_On_but_disallow_access_above_lock_OR_Disabled_but_not_Enabled_On
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsInkWorkspace\AllowWindowsInkWorkspace':
  ensure => present,
  type   => dword,
  data   => 0,
}
...
# rule_18.9.101.1.1_L1_Ensure_Manage_preview_builds_is_set_to_Enabled_Disable_preview_builds
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\ManagePreviewBuilds':
  ensure => present,
  type   => dword,
  data   => 1,
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\ManagePreviewBuildsPolicyValue':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule_18.9.101.1.2_L1_Ensure_Select_when_Preview_Builds_and_Feature_Updates_are_received_is_set_to_Enabled_Semi-Annual_Channel_180_or_more_days
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\DeferFeatureUpdates':
  ensure => present,
  type   => dword,
  data   => 1,
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\DeferFeatureUpdatesPeriodInDays':
  ensure => present,
  type   => dword,
  data   => 180,
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\BranchReadinessLevel':
  ensure => present,
  type   => dword,
  data   => 32,
}

# rule_18.9.101.1.3_L1_Ensure_Select_when_Quality_Updates_are_received_is_set_to_Enabled_0_days
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\DeferQualityUpdates':
  ensure => present,
  type   => dword,
  data   => 1,
}
registry_value { 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\DeferQualityUpdatesPeriodInDays':
  ensure => present,
  type   => dword,
  data   => 0,
}

# rule 19.7.7.1 L1 Ensure Configure Windows spotlight on lock screen is set to Disabled
registry_value { 'HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\CloudContent\ConfigureWindowsSpotlight':
  ensure => present,
  type   => dword,
  data   => 2,
}
...
# rule_19.7.7.1_L1_Ensure_Configure_Windows_spotlight_on_lock_screen_is_set_to_Disabled
registry_value { 'HKEY_USERS\.DEFAULT\Software\Policies\Microsoft\Windows\CloudContent\ConfigureWindowsSpotlight':
  ensure => present,
  type   => dword,
  data   => 2,
}

# rule_19.7.7.2_L1_Ensure_Do_not_suggest_third-party_content_in_Windows_spotlight_is_set_to_Enabled
registry_value { 'HKEY_USERS\.DEFAULT\Software\Policies\Microsoft\Windows\CloudContent\DisableThirdPartySuggestions':
  ensure => present,
  type   => dword,
  data   => 1,
}
